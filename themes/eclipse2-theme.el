;;; eclipse2-theme.el --- Theme based on Eclipse circa 2010
  ...
  (apply 'custom-theme-set-faces 'eclipse2
         (mapcar
          ...
          `((default
            ...
            (font-lock-builtin-face :foreground ,eclipse-builtin)
            ...
            (org-level-2 :weight bold :foreground "#801515")
            (org-level-3 :weight bold :foreground "#2b4970")
            (org-level-4 :weight bold :foreground "#116611")
            (org-level-5 :weight bold :foreground "#aa5c39")
            (org-level-6 :weight bold :foreground "#aa3939")
            (org-level-7 :weight bold :foreground "#2a4970")
            (org-level-8 :weight bold :foreground "#472e74")
            ...
            ;; other packages
            (ein:cell-input-area :background "floral white")
...
(provide-theme 'eclipse2)

;;; eclipse2-theme.el ends here
