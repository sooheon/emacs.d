...
;;;
;;; System Requirements:  (version-list-<= (version-to-list emacs-version) '(25 2 1))
;;;
...
-    \\{undo-tree-visual-mode-map}"
  ...
  (unless (version-list-<= (version-to-list emacs-version) '(25 2 1))
    (let ((debug-on-quit nil))
      (setq undo-tree-mode nil)
      (signal 'quit '("undo-tree-mode:  Sorry ... undo-tree is incompatible with > Emacs 25.2.1"))))
